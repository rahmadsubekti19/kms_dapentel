									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												document.getElementById('knowledgeDestroy-{{$itemKnowledge->id}}').submit();">Delete</a>
												<form action="{{route('knowledgeDestroy', $itemKnowledge->id)}}"  id="knowledgeDestroy-{{$itemKnowledge->id}}" method="POST" style="display: none;"> 
													{{ csrf_field() }}
													{{ method_field('DELETE')}}
												</form>
											</td>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<a href="#" class="btn btn-danger" 
												onclick="event.preventDefault(); 
												document.getElementById('knowledgeDestroy-{{$item->id}}').submit();">Delete</a>
												<form action="{{route('knowledgeDestroy', $item->id)}}"  id="knowledgeDestroy-{{$item->id}}" method="POST" style="display: none;"> 
													{{ csrf_field() }}
													{{ method_field('DELETE')}}
												</form>
											</td>
